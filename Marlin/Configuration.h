...
#define STRING_CONFIG_H_AUTHOR "(YOHAN NAFTALI, Ender-3v2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3V2-V4.2.7-Hemera-BLT"
...
#define HEATER_0_MINTEMP   5  // Ender Configs 0, hemera use 5
...
#define BED_MINTEMP        5  // Ender Configs 0, hemera use 5
#define CHAMBER_MINTEMP    5

// Above this temperature the heater will be switched off.
// This can protect components from overheating, but NOT from shorts and failures.
// (Use MINTEMP for thermistor short/failure protection.)
#define HEATER_0_MAXTEMP 300  // Ender Configs 275, hemera 300 
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 409 }   // Hemera Configs
...
#define Z_MIN_PROBE_PIN PB1 // Pin PB1 for Creality V4 Board
// #define Z_MIN_PROBE_PIN 17 // Pin 17 for Creality V427 Board
...
#define NOZZLE_TO_PROBE_OFFSET { 71, 0, -2.2 } // Hemera
...
#define X_BED_SIZE 220  // Ender 3 V2 printable bed size - Hemera reduce
//#define Y_BED_SIZE 220
#define Y_BED_SIZE 215 // 235 - MANUAL_Y_HOME_POS - 5 = 235-19-5=220

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0  // MRiscoC Stock physical limit
#define Y_MIN_POS 0  // MRiscoC Stock physical limit
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE  // Hemera
#define Y_MAX_POS Y_BED_SIZE  // Hemera
//#define Z_MAX_POS 250 
#define Z_MAX_POS 220         // Hemera reduce printable height
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  // #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 } // Top Left
  //#define NOZZLE_PARK_POINT { (X_BED_SIZE + 10), (Y_MAX_POS - 10), 20 }
  // Park on Right Bottom
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 20), (Y_MIN_POS + 20), 20 }
